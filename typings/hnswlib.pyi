...
class BFIndex:
    ...
    def knn_query(
        ...
        filter: collections.abc.Callable[[typing.SupportsInt], bool] = ...,
    ) -> object: ...
    def load_index(
        self, path_to_index: str, max_elements: typing.SupportsInt = ...
    ) -> None: ...
...
class Index:
    ...
    def init_index(
        self,
        max_elements: typing.SupportsInt,
        M: typing.SupportsInt = ...,
        ef_construction: typing.SupportsInt = ...,
        random_seed: typing.SupportsInt = ...,
