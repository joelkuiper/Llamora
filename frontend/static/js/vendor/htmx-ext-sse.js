...
!(function () {
    ...
    if (e.getAttributeValue(t, "sse-swap")) {
      ...
      for (
        var n = e.getInternalData(u).sseEventSource,
          r = e.getAttributeValue(t, "sse-swap").split(","),
          o = 0;
        o < r.length;
        o++
      ) {
        const i = r[o].trim(),
          c = function (r) {
            s(u) ||
              (e.bodyContains(t)
                ? e.triggerEvent(t, "htmx:sseBeforeMessage", r) &&
                  (a(t, r.data), e.triggerEvent(t, "htmx:sseMessage", r))
                : n.removeEventListener(i, c));
          };
    ...
    if (e.getAttributeValue(t, "hx-trigger")) {
      ...
      e.getTriggerSpecs(t).forEach(function (r) {
        if ("sse:" === r.trigger.slice(0, 4)) {
          var a = function (i) {
            s(u) ||
              (e.bodyContains(t) || n.removeEventListener(r.trigger.slice(4), a),
              htmx.trigger(t, r.trigger, i),
              htmx.trigger(t, "htmx:sseMessage", i));
          };
  ...
  function r(t, a) {
    ...
    if (e.getAttributeValue(t, "sse-connect")) {
      var i = e.getAttributeValue(t, "sse-connect");
      if (null == i) return;
      !(function (t, a, i) {
        var o = htmx.createEventSource(a);
        (o.onerror = function (n) {
          if (
            (e.triggerErrorEvent(t, "htmx:sseError", { error: n, source: o }),
            !s(t) && o.readyState === EventSource.CLOSED)
          ) {
            i = i || 0;
  ...
  function s(t) {
    if (!e.bodyContains(t)) {
      ...
      if (null != n)
        return (
          e.triggerEvent(t, "htmx:sseClose", { source: n, type: "nodeMissing" }), n.close(), !0
        );
    }
    return !1;
  }
    ...
    onEvent: function (t, n) {
      ...
      switch (t) {
        case "htmx:beforeCleanupElement":
          ...
          return void (
            i &&
            (e.triggerEvent(s, "htmx:sseClose", { source: i, type: "nodeReplaced" }),
            a.sseEventSource.close())
          );
