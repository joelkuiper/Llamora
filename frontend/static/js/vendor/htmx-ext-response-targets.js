...
!(function () {
  ...
  function t(e) {
    e.detail.isError
      ? htmx.config.responseTargetUnsetsError && (e.detail.isError = !1)
      : htmx.config.responseTargetSetsError && (e.detail.isError = !0);
  }
  htmx.defineExtension("response-targets", {
    init: function (r) {
      (e = r),
        ...
        void 0 === htmx.config.responseTargetPrefersRetargetHeader &&
          (htmx.config.responseTargetPrefersRetargetHeader = !0);
    },
    onEvent: function (s, n) {
      if ("htmx:beforeSwap" === s && n.detail.xhr && 200 !== n.detail.xhr.status) {
        ...
        if (!n.detail.requestConfig) return !0;
        var i = (function (t, s) {
          if (!t || !s) return null;
          var n = s.toString(),
            i = [
        ...
        return i && (t(n), (n.detail.shouldSwap = !0), (n.detail.target = i)), !0;
      }
    },
  });
})();
