...
(function (g, f) {
    ...
    we = (a, e, t, n) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let r of Re(e))
          !Oe.call(a, r) &&
            r !== t &&
            H(a, r, { get: () => e[r], enumerable: !(n = be(e, r)) || n.enumerable });
      return a;
    };
  ...
  var m = {
    ...
    ke = h(/^!?\[(ref)\](?:\[\])?/)
      .replace("ref", U)
      .getRegex(),
    et = h("reflink|nolink(?!\\()", "g").replace("reflink", de).replace("nolink", ke).getRegex(),
    J = {
      _backpedal: C,
      anyPunctuation: We,
      autolink: Xe,
...
`),
        ...
        for (; n.length > 0; ) {
          ...
          for (u = 0; u < n.length; u++)
            if (this.rules.other.blockquoteStart.test(n[u])) l.push(n[u]), (o = !0);
...
`,
              ...
              if (
                ((k = G),
                this.options.pedantic
                  ? ((k = k.replace(this.rules.other.listReplaceNesting, "  ")), (E = k))
                  : (E = k.replace(this.rules.other.tabCharGlobal, "    ")),
                ne.test(k) || re.test(k) || xe.test(k) || Z.test(k) || te.test(k))
              )
                break;
...
`),
          ...
          this.options.gfm &&
            ...
            T && ((ee = T[0] !== "[ ] "), (c = c.replace(this.rules.other.listReplaceTask, "")))),
            i.items.push({
              type: "list_item",
              raw: p,
              task: !!T,
...
`
    ...
    codespan(e) {
      ...
      if (t) {
        ...
        return (
          r && i && (n = n.substring(1, n.length - 1)), { type: "codespan", raw: t[0], text: n }
        );
      }
    }
    br(e) {
          ...
          ? e.tokens[0]?.type === "paragraph"
            ? ((e.tokens[0].text = n + " " + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                ((e.tokens[0].tokens[0].text = n + " " + w(e.tokens[0].tokens[0].text)),
              ...
              $.passThroughHooks.has(s)
                ? (i[o] = (p) => {
                    if (this.defaults.async)
                      return Promise.resolve(l.call(i, p)).then((f) => u.call(i, f));
                    let c = l.call(i, p);
                    return u.call(i, c);
                  })
                : (i[o] = (...p) => {
      ...
      return (n, r) => {
        ...
        if (s.async)
          return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n)
            ...
            .then((p) =>
              s.walkTokens ? Promise.all(this.walkTokens(p, s.walkTokens)).then(() => p) : p,
            )
            .then((p) => u(p, s))
