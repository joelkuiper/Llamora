var htmx = (function () {
    ...
    if (!yt) {
      ...
      setInterval(function () {
        if (mt) {
          mt = false;
          ie(
            te().querySelectorAll("[hx-trigger*='revealed'],[data-hx-trigger*='revealed']"),
            function (e) {
              bt(e);
            },
          );
  ...
  function Bt(e, t) {
    return new CustomEvent(e, { bubbles: true, cancelable: true, composed: true, detail: t });
  }
  function fe(e, t, n) {
    ae(e, t, le({ error: t }, n));
  }
  ...
  function Gt() {
    ...
    if (Q.config.historyEnabled) history.replaceState({ htmx: true }, te().title, location.href);
  }
  function Wt(e) {
  ...
  function Qt(e) {
    ...
    t.onload = function () {
      if (this.status >= 200 && this.status < 400) {
        ...
        $e(r.historyElt, r.response, n, { contextElement: r.historyElt, historyRequest: true });
        _t(r.path);
  ...
  function an(e, t) {
    ...
    if (n.willValidate) {
      ...
      if (!n.checkValidity()) {
        ...
        ae(n, "htmx:validation:failed", { message: n.validationMessage, validity: n.validity });
      }
    }
  }
  function hn(n, e) {
  ...
  function dn(e, t) {
    ...
    let l =
      (e instanceof HTMLFormElement && e.noValidate !== true) || a(e, "hx-validate") === "true";
